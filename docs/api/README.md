...
This client is automatically generated from the [Jules OpenAPI specification](_media/jules-openapi.yaml) using [@hey-api/openapi-ts](https://heyapi.vercel.app/openapi-ts/).
...
For details on the parameters and return types for each function, please refer to the TypeScript definitions included in this package or the source [OpenAPI specification](_media/jules-openapi.yaml).
